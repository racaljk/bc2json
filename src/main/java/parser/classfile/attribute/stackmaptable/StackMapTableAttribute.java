...
import parser.classfile.attribute.ExcludeFields;
import parser.classfile.constant.VerificationTypeItems;
...
/*
The StackMapTable parser.classfile.attribute is a variable-length parser.classfile.attribute in the attributes table
of a Code parser.classfile.attribute (§4.7.3). A StackMapTable parser.classfile.attribute is used during the process
of verification by type checking (§4.10.1).
There may be at most one StackMapTable parser.classfile.attribute in the attributes table of a
Code parser.classfile.attribute.
In a class file whose version number is 50.0 or above, if a method's Code parser.classfile.attribute
does not have a StackMapTable parser.classfile.attribute, it has an implicit stack map parser.classfile.attribute
(§4.10.1). This implicit stack map parser.classfile.attribute is equivalent to a StackMapTable
parser.classfile.attribute with number_of_entries equal to zero.
 */
...
public class StackMapTableAttribute extends Attribute {
    ...
    //public descriptor used for stack map frame parser.classfile.factory in other package
